...
type SqlTypeProvider(config: TypeProviderConfig) as this =     
    ...
    let createTypes(conString,companyName,resolutionPath,individualsAmount,useOptionTypes,owner, rootTypeName) =       
...
//              yield meth
    ...
    do paramSqlType.DefineStaticParameters([conString;companyName;resolutionPath;individualsAmount;optionTypes;owner], fun typeName args -> 
